...
const Result = () => {
    ...
    return (
      <div className="background">
          ...
          {loading ? <Loading text="싸이코패스 제조 중"/> : null}
          {popupOpen ? <SocialShare setPopupOpen={setPopupOpen}/> : null}
          <div className="result">
              <div ref={cardRef} className='png-card'>
                  <div className='drink-name'>
                      <div style={{ fontFamily: 'NanumSquareRoundR', fontSize: '60%', letterSpacing: '-1pt' }}>당신의
                          싸이코패스는...
                      </div>
                  ...
                  <div className='human-character'>
                      {resultDrink.character.map((ex, index) => {
                          return <Character key={index} idx={index} item={ex} onClickCharacter={onClickCharacter}
